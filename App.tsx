      ...
      <main>
        ...
        <div className="max-w-4xl mx-auto mt-12 mb-20">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200 aspect-video mx-4 md:mx-0 relative">
            {/* Using a generic channel/playlist embed since dynamic feed requires API key. 
                      This simulates the 'Slider' experience by showing the latest content. 
                      Ideally, this would be a playlist of 'Recent Uploads'. 
                      Here we point to the channel's main video or a common playlist if known, 
                      falling back to the channel page in an iframe isn't allowed by YouTube (X-Frame-Options).
                      So we must use the distinct 'embed' URL.
                  */}
            <iframe
