        ...
        {view === 'USER_LOGIN' && (
          <div className="max-w-md mx-auto mt-20 p-8 bg-white rounded-2xl shadow-xl border border-slate-100">
            ...
            <form onSubmit={handleUserLogin} className="space-y-6">
              ...
              <button className="w-full py-4 bg-blue-600 text-white rounded-xl font-bold text-lg hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all active:scale-[0.98]">
                PDF'e Eriş
              </button>
            </form>
