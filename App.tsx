...
const App: React.FC = () => {
  ...
  import { DBBook, DBCollection, Folder, FolderContent, AccessKey, UserProfile, UserPermission, ViewState, PDFBook } from './types';
  ...
  function App() {
    ...
    const [viewState, setViewState] = useState<ViewState>('USER_LOGIN');
